cd ../..
mkdir models/aug/en_bert-$1p-$3l-$4d/
python src/main.py train \
    --train-path data/02-21.10way.clean.$1p.aug \
    --dev-path data/22.auto.clean.$1p.aug \
    --model-path-base models/aug/en_bert-$1p-$3l-$4d/model-$2-pa$5 \
