cd ../..
mkdir models/aug_leaf/en_bert-$1p-$3l-$4d/
python src/main.py train \
    --train-path data/02-21.10way.clean.$1p.leaf \
    --dev-path data/22.auto.clean.$1p.leaf \
    --model-path-base models/aug_leaf/en_bert-$1p-$3l-$4d/model-$2-pa$5 \
