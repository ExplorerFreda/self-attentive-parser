...
cd ../..
mkdir models/japanese/baseline_mling_bert-$1ex-$3l-$4d/
python src/main.py train \
    --train-path data/japanese_train.txt.$1l \
    --dev-path data/japanese_dev.txt.5l \
    --model-path-base models/japanese/baseline_mling_bert-$1ex-$3l-$4d/model-$2-pa$5 \
