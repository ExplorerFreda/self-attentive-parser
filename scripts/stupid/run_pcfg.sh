cd ../..
mkdir models/stupid/pcfg_en_bert-$1ex-$3l-$4d/
python src/main.py train \
    --train-path data/02-21.10way.clean.$1l.pcfg \
    --dev-path data/22.auto.clean.5l.pcfg \
    --model-path-base models/stupid/pcfg_en_bert-$1ex-$3l-$4d/model-$2-pa$5 \
