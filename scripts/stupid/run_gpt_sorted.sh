cd ../..
mkdir models/stupid/GPTsorted_en_bert-$1ex-$3l-$4d/
python src/main.py train \
    --train-path data/02-21.10way.clean.$1l.replace.sorted \
    --dev-path data/22.auto.clean.5l.replace \
    --model-path-base models/stupid/GPTsorted_en_bert-$1ex-$3l-$4d/model-$2-pa$5 \
